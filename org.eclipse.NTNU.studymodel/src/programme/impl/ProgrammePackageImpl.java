...
public class ProgrammePackageImpl extends EPackageImpl implements ProgrammePackage {
	 ...
	 */
	@Override
	public EReference getProgramme_AvailableSpecializations() {
	 ...
	 */
	@Override
	public EReference getProgramme_StudyYears() {
	 ...
	 */
	@Override
	public EReference getSpecialization_AvailableSpecializations() {
	 ...
	 */
	@Override
	public EReference getSpecialization_StudyYears() {
	 ...
	 */
	@Override
	public EAttribute getCourse_TaugtIn() {
	 ...
	 */
	@Override
	public EAttribute getStudyYear_Year() {
		return (EAttribute)studyYearEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getStudyYear_Semesters() {
		return (EReference)studyYearEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(programmeEClass, PROGRAMME__AVAILABLE_SPECIALIZATIONS);
		createEAttribute(programmeEClass, PROGRAMME__PROGRAMME_TYPE);
		createEReference(programmeEClass, PROGRAMME__STUDY_YEARS);
		...
		createEReference(specializationEClass, SPECIALIZATION__AVAILABLE_SPECIALIZATIONS);
		createEReference(specializationEClass, SPECIALIZATION__STUDY_YEARS);

		courseEClass = createEClass(COURSE);
		createEAttribute(courseEClass, COURSE__NAME);
		createEAttribute(courseEClass, COURSE__CODE);
		createEAttribute(courseEClass, COURSE__TAUGT_IN);
		createEAttribute(courseEClass, COURSE__LEVEL);
		createEAttribute(courseEClass, COURSE__CREDITS);

		studyYearEClass = createEClass(STUDY_YEAR);
		createEAttribute(studyYearEClass, STUDY_YEAR__YEAR);
		createEReference(studyYearEClass, STUDY_YEAR__SEMESTERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getProgramme_AvailableSpecializations(), this.getSpecialization(), null, "availableSpecializations", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProgramme_StudyYears(), this.getStudyYear(), null, "studyYears", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProgramme_Code(), ecorePackage.getEString(), "code", null, 1, 1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpecialization_AvailableSpecializations(), this.getSpecialization(), null, "availableSpecializations", null, 0, -1, Specialization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSpecialization_StudyYears(), this.getStudyYear(), null, "studyYears", null, 0, -1, Specialization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourse_TaugtIn(), this.getSemesterType(), "taugtIn", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Level(), this.getCourseLevel(), "level", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStudyYear_Year(), ecorePackage.getEInt(), "year", null, 1, 1, StudyYear.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStudyYear_Semesters(), this.getSemester(), null, "semesters", null, 2, 2, StudyYear.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.MASTER_2YEARS);
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.INTEGRATED_MASTER);
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.YEAR_STUDY);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (courseEClass,
		   source,
		   new String[] {
			   "constraints", "courseCreditsShouldBeOver5"
		   });
		addAnnotation
		  (studyYearEClass,
		   source,
		   new String[] {
			   "constraints", "mustContainFallAndSpringSemesters"
		   });
		addAnnotation
		  (semesterEClass,
		   source,
		   new String[] {
			   "constraints", "semesterTypesMustMatch"
		   });
	}
	...
	protected void create_1Annotations() {
		...
		addAnnotation
		  (courseEClass,
		   source,
		   new String[] {
			   "courseCreditsShouldBeOver5", "self.credits -> sum() >= 5.0"
		   });
	}
